(function(d3, localization) {
  ...
  /********************************************************************
            LINE CHART DU TAUX D'INCIDENCE CHEZ LES HOMMES
   *******************************************************************/
d3.csv("./data/IncidenceHommes.csv", function(error, data) {
...
// Render the chart
  ...
  /********************************************************************
            LINE CHART DU TAUX DE MORTALITE CHEZ LES HOMMES
   *******************************************************************/

d3.csv("./data/DecesHommes.csv", function(error, data) {
    data.forEach(function (d) {
        d.Annee = +d.Annee;
        d.Prostate = +d.Prostate;
        d.Colorectal = +d.Colorectal;
        ...
        d.Lymphomenonhodgkinien = +d.Lymphomenonhodgkinien;
        d.Estomac = +d.Estomac;
        d.Foie = +d.Foie;
        d.Bouche = +d.Bouche;
        d.Larynx = + d.Larynx;
    ...
    var chart = makeLineChart(data, 'Annee', {
        ...
        'Colorectal': {column: 'Colorectal'},
        'Poumon': {column: 'Poumons'},
        'Pancreas': {column: 'Pancreas'},
        'Lymphome': {column: 'Lymphomenonhodgkinien'},
        'Estomac': {column: 'Estomac'},
        'Foie': {column: 'Foie'},
        'Bouche': {column: 'Bouche'}
    }, {xAxis: 'Années', yAxis: 'Taux normalisé de mortalité'});
    chart.bind("#chart-lineHD");
    chart.render();
